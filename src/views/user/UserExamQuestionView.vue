       ...
       <div>
         <Card size="small" style="height: 100%; ">
           <div class="problemsItemList" style="height: 100%">
             ...
             <div v-else class="problemsItem" v-for="(i, index) in validQuestionGroups" :key="i.id">
   ...
   const validQuestionGroups = computed(() => allQuestionGroups.value.filter(item => item !== null && item !== undefined));
