<template>
  <ViewQuestionHeader @runResultUUID="getRunResultUUID" :inputList="inputList" @submit="getSubmit" :info="form"></ViewQuestionHeader>
              ...
              <a-card v-if="question" style="padding: 0; border-radius: 10px; height: 100vh ">
                <div style="flex: 1">
                  ...
                  <div style="">
                    ...
                    <div style="height:90vh; padding: 20px;overflow-y: auto;"
                  ...
                  <a-space direction="vertical" size="large" style="display: flex; flex-direction: column; flex: 1; ">
                    <a-card  style="padding: 0;flex: 1; border-radius: 10px;">
                      <div style="display:flex;flex: 1; flex-direction: column;  ">
                        ...
                        <div v-if="testView==='case'" style="display: flex; height: 240px; flex-direction: column; overflow-y: scroll; padding: 20px; ">
                          <div>
                            <div style="display:flex; flex-direction: column">
                              <div style="font-size: 14px; font-weight: 700">输入: (每个输入请通过空格进行分割)</div>
                              <br>
                              <Input v-model:value="inputList" style="padding:10px;font-size: 16px; height:50px; background-color:#f1f6f6;border-radius: 10px">
                        ...
                        <div v-if="testView==='result'" style="display: flex; height: 240px; flex-direction: column; overflow-y: scroll; padding: 20px;">
                          <div v-if="isLoading">
                            <Spin tip="判题中..." style="display: flex; width: 100%; height: 100%; justify-content: center;align-items: center" :spinning="spinning">
                          ...
                          <div v-else>
                            <div>
                              <div v-if="typeof runResultOutPut !== 'undefined' && runResultOutPut.length > 0">
                                ...
                                输出=
                                <div style="color:#000000; border-radius: 10px; background: #f6363614; margin-top: 10px; padding: 10px; font-size: 16px;">
                                  {{runResultOutPut}}
                                </div>
                              </div>
                              <div v-else>
                                ...
                                <div style="color:#f63636; border-radius: 10px; background: #f6363614; margin-top: 10px; padding: 10px; font-size: 14px;">
...
let id = ref<string>("1777315294176382978")
