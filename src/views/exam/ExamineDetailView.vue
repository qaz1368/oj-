...
<!--            <CodeOutlined  style="font-size: 70px" />-->
        ...
        <div style="flex: 7; display: flex; flex-direction: column; justify-content: space-between">
          ...
          <div>
            <aButton class="fontFamily" type="primary" style="height: 40px; border-radius: 5px; font-size: 16px">查看试卷</aButton>
          </div>
        </div>
      </div>
      ...
      <div style="margin-top: 30px">
        <Card style="display: flex;padding: 10px 0; flex-direction: column; box-shadow: 0 2px 6px rgba(218,203,203,0.06),0 4px 8px rgba(217,202,202,0.06),0 6px 12px rgba(218,204,204,0.06)">
          ...
          <div class="examineConfig">
            ...
            <div class="examineConfigFont2 fontFamily2">2024/03/19 18:22:00</div>
          </div>
          <div class="examineConfig">
            <div class="examineConfigFont">关闭时间</div>
            <div class="examineConfigFont2 fontFamily2">2024/03/19 20:22:00</div>
          </div>
          <div class="examineConfig">
            <div class="examineConfigFont">限制答题时长</div>
            <div class="examineConfigFont2 fontFamily2">120分钟</div>
          </div>
          <div class="examineConfig">
            <div class="examineConfigFont">开放状态</div>
            <div class="examineConfigFont2 fontFamily2">已关闭</div>
          </div>
        </Card>
      </div>
    </div>
