...
import type { BaseResponse_List_QuestionGroup_ } from '../models/BaseResponse_List_QuestionGroup_';
import type { BaseResponse_List_UserRankingVO_ } from '../models/BaseResponse_List_UserRankingVO_';
...
id?: number,
    ...
    /**
     * getNowQuestionGroup
     * @returns BaseResponse_List_QuestionGroup_ OK
     * @throws ApiError
     */
    public static getNowQuestionGroupUsingGet(): CancelablePromise<BaseResponse_List_QuestionGroup_> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/user/getNowQuestionGroup',
            errors: {
                401: `Unauthorized`,
                403: `Forbidden`,
                404: `Not Found`,
    ...
    /**
     * getUserQuestionGroup
     * @returns BaseResponse_List_QuestionGroup_ OK
     * @throws ApiError
     */
    public static getUserQuestionGroupUsingGet(): CancelablePromise<BaseResponse_List_QuestionGroup_> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/user/getUserQuestionGroup',
            errors: {
                401: `Unauthorized`,
                403: `Forbidden`,
                404: `Not Found`,
...
userLoginRequest: UserLoginRequest,
    ...
    /**
     * getRanking
     * @returns BaseResponse_List_UserRankingVO_ OK
     * @throws ApiError
     */
    public static getRankingUsingGet(): CancelablePromise<BaseResponse_List_UserRankingVO_> {
        return __request(OpenAPI, {
            method: 'GET',
...
userRegisterRequest: UserRegisterRequest,
     ...
     * @throws ApiError
     */
    public static getScheduleUsingGet(): CancelablePromise<BaseResponse_ScheduleVO_> {
        return __request(OpenAPI, {
            method: 'GET',
